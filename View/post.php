...
<main class="amber lighten-4">
    <div class="container-fluid amber lighten-4 pt-3 pb-5">
        <div class="container card green lighten-2 card">
            ...
            <?php else: ?>
                ...
                <?php if(empty($_SESSION['is_user']) && empty($_SESSION['is_admin'])): ?>
                    <a href="<?=ROOT_URL?>?p=blog&amp;a=login"><button class="btn light-blue waves-effect waves-light">Se connecter pour commenter</button></a>
                    <br><br>
                <?php else: ?>
                    <h4>Commenter :</h4>
                    ...
                    <form method="post">
                        <div class="row">
                            <div class="input-field col s12">
                                <textarea name="comment" id="comment" class="white materialize-textarea" maxlength="1200"></textarea>
                                <label for="comment">Commentaire</label>
                            </div>
                            <div class="col s12">
                                <button type="submit" name="submit_comment" class="btn light-blue waves-effect waves-light">
                                    Commenter
                                </button>
                            </div>
                        </div>
